...
export class AppInitConfig {
    ...
    RandomInfectionProbability: number = 0.1; //a chance factor to be infected by a person external to the test e.g visit from infected family member / business road warrior / postman
    ReinfectionProbability: number = 0.1;
